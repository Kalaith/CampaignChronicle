...
# Configuration
$SOURCE_DIR = "H:\WebHatchery\apps\campaign_chronicle"
...
$DEST_DIR = Join-Path $DEST_ROOT "campaign_chronicle"
...
function Build-Frontend {
    ...
    # Set base path for preview environment (campaign_chronicle subdirectory)
    if ($Environment -eq 'preview') {
        Write-Info "Setting base path for preview environment..."
        $env:VITE_BASE_PATH = "/campaign_chronicle/"
