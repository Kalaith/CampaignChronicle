// Toast Container Component - Manages toast notifications with animation
...
// Helper hooks for creating toasts
export const useToast = () => {
  const { addToast } = useAppStore();

  const showToast = (type: ToastProps['type'], message: string, options?: Partial<ToastProps>) => {
    return addToast({
      type,
      message,
      ...options,
